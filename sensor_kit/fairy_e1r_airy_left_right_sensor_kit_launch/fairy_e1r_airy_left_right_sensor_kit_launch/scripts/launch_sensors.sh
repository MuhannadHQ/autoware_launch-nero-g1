#!/usr/bin/env bash
# =============================================================================
# launch_sensors.sh -- fairy_e1r_airy_left_right_sensor_kit
#
...
#     Airy Right  right  192.168.1.204  MSOP 6655  DIFOP 7744
...
KIT_PKG="fairy_e1r_airy_left_right_sensor_kit_launch"
...
LIDARS=(
  ...
  "Airy Right|right|192.168.1.204|6655|7744"
)
...
check_conflicts() {
  ...
  local clash=""
  for n in /pointcloud_container /robot_state_publisher /sensing/lidar/concatenate_data \
           /sensing/lidar/top/fairy_ros_wrapper_node /sensing/lidar/front/e1r_ros_wrapper_node \
           /sensing/lidar/left/airy_left_ros_wrapper_node /sensing/lidar/right/airy_right_ros_wrapper_node \
           /sensing/gnss/septentrio_gnss_driver /sensing/gnss/xsens_mti_node; do
