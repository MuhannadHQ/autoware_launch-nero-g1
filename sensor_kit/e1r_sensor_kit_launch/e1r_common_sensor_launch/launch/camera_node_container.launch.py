...
def launch_setup(context, *args, **kwargs):
    ...
    # yolo_model_path = "/home/nero_station/autoware_data/tensorrt_yolox/yolox-tiny.onnx"
    # yolo_label_path = "/home/nero_station/autoware_data/tensorrt_yolox/label.txt"
    # yolo_color_map_path = "/home/nero_station/autoware_data/tensorrt_yolox/semseg_color_map.csv"
        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                parameters=[{
                    ...
                    "image_vertical_flip": camera_yaml_param.get('image_vertical_flip', False),
                    "image_horizontal_flip": camera_yaml_param.get('image_horizontal_flip', False),
                }],
                remappings=[
                ],
                extra_arguments=[
            ...
            #             "color_map_path": yolo_color_map_path,
            ...
            #             # Inference settings
            #             "precision": tensorrt_yaml_param['precision'],
            #             "gpu_id": tensorrt_yaml_param['gpu_id'],
            ...
            #                     "UNKNOWN": tensorrt_yaml_param['roi_overlay_segment_label']['UNKNOWN'],
            #                     "CAR": tensorrt_yaml_param['roi_overlay_segment_label']['CAR'],
            #                     "TRUCK": tensorrt_yaml_param['roi_overlay_segment_label']['TRUCK'],
            #                     "BUS": tensorrt_yaml_param['roi_overlay_segment_label']['BUS'],
            #                     "MOTORCYCLE": tensorrt_yaml_param['roi_overlay_segment_label']['MOTORCYCLE'],
            #                     "BICYCLE": tensorrt_yaml_param['roi_overlay_segment_label']['BICYCLE'],
            #                     "PEDESTRIAN": tensorrt_yaml_param['roi_overlay_segment_label']['PEDESTRIAN'],
            #                     "ANIMAL": tensorrt_yaml_param['roi_overlay_segment_label']['ANIMAL'],
            #                 },
            #     }],
            #     remappings=[
