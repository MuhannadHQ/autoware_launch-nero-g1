...
def launch_setup(context, *args, **kwargs):
    ...
    fairy_node = ComposableNode(
        ...
        remappings=[
            ("fairy_points", "pointcloud_before_sync"),
            ("aw_points", "aw_points"),
...
def generate_launch_description():
    launch_arguments = [
        ...
        DeclareLaunchArgument("frame_id", default_value="rslidar"),
        DeclareLaunchArgument("return_mode", default_value="Strongest"),
        # ── Crop-box filter args ──
        DeclareLaunchArgument("input_frame", default_value="rslidar"),
        DeclareLaunchArgument("output_frame", default_value="rslidar"),
