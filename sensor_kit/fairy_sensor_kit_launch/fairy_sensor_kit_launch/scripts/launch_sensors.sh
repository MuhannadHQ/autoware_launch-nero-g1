#!/usr/bin/env bash
# =============================================================================
# launch_sensors.sh -- fairy_sensor_kit
#
...
#     --no-lidar            do not launch the LiDAR driver (and do not check it)
...
KIT_PKG="fairy_sensor_kit_launch"
...
check_conflicts() {
  ...
  local clash=""
  for n in /pointcloud_container /robot_state_publisher /sensing/lidar/pose_estimator_relay /sensing/lidar/top/fairy_ros_wrapper_node /sensing/gnss/septentrio_gnss_driver /sensing/gnss/xsens_mti_node; do
