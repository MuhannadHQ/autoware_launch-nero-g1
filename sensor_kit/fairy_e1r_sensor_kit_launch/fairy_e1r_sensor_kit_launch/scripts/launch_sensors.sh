#!/usr/bin/env bash
# =============================================================================
# launch_sensors.sh -- fairy_e1r_sensor_kit
#
...
KIT_PKG="fairy_e1r_sensor_kit_launch"
...
check_conflicts() {
  ...
  local clash=""
  for n in /pointcloud_container /robot_state_publisher /sensing/lidar/concatenate_data /sensing/lidar/top/fairy_ros_wrapper_node /sensing/lidar/front/e1r_ros_wrapper_node /sensing/gnss/septentrio_gnss_driver /sensing/gnss/xsens_mti_node; do
