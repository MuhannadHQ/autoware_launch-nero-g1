...
def generate_launch_description():
    ...
    fairy_e1r_airy_left_sensor_kit_launch_share_dir = get_package_share_directory("fairy_e1r_airy_left_sensor_kit_launch")
    ...
    add_launch_arg(
        ...
        os.path.join(
            fairy_e1r_airy_left_sensor_kit_launch_share_dir,
            "config",
