...
def get_lidar_make(sensor_name):
    ...
    elif sensor_name.lower() in ["helios", "bpearl", "ac1"]:
...
def launch_setup(context, *args, **kwargs):
    ...
    nodes.append(
        ComposableNode(
            package="lidar_pointcloud_converter",
            executable="lidar_pointcloud_converter_node",
            name="lidar_pointcloud_converter_node",
            output="screen",

            remappings=[
                ("/points_in", "pointcloud_raw_ex"),
            ],
    ...
    nodes.append(
        ComposableNode(
            ...
            remappings=[
                ("input", "mirror_cropped/pointcloud_ex"), # changed since distortion corrector skipped
